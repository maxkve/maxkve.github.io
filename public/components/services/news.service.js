...
angular.module("epgpApp").service("newsService", function() {
  let news = [
    ...
    {
      title: "Player Introduction: Boombeard",
      img: "classic.jpg",
      date: "2019-08-26",
      tags: ["Player Introduction"],
      summary: "Learn more about Boombeard, ex-truck driver and bane of orcs.",
      content:
        "I'm 45, from  the north of England. I used to be a truck driver,( the crazy one trying to ram you off the road). Now I don’t work, I  have not for a while. I see myself as a retired gentleman of leisure lol. Warcraft veteran I played since vanilla but left retail a few months ago. Multiple characters and multiple realms, cleared lots of content when it was live. I’m a bit crazy but fun as you will soon get to know.  I have already met  some of you looking forward to meeting the rest of you.  Remember to kill all horde or Shinobi might visit you in the night!!!   (I think the police call it home invasion) lol.<br><br><b>In game</b><br>As the 126th Ironbeard archaeological excavation force reached the dig site in the highest, most dangerous peaks of the Alterac mountains. The wind and snow howled all around them, but still there was great excitement within the team as they had never ventured so deep into the mountain range before and hopefully they would find some great relics . They made camp, ready to make a fresh start in the morning. But the night had other ideas. In the distance they could hear howling, they put it down to a wild animal at first, but then on a ridge not a hundred yards from the camp, torches appeared one by one in the darkest shadows. The silhouettes appeared of the hulking, menacing figures of orcs. 10 of them in total, all the Frostwolf clan. Ironbeard ordered his men to prepare for battle. Outnumbered 2 to 1, they would at the very least take some of the foul beasts with them.	The Orc battle cry could be heard from miles around, echoing through the snow-capped peaks. Suddenly, a gunshot rang out 'BOOM' it came from the right flank. The war band leader was struck in the neck by a deadly aimed shot,  and instantly killed. His lifeless body slid from his frost wolf howler as jets of black orc blood sprayed over the crisp white snow. A second rider was cut down in a hail of bullets. Ironbeard recognised the distinctive sound of a Dwarven Hand Cannon. Not many dwarfs used them anymore, but he knew a dwarf that still favoured one. His second cousin Boombeard, could it be him after all these years?  Seizing the opportunity Ironbeard ordered his men to attack. “FOR KHAZ MODAN! “. The battle ended swiftly, all orc apart from one were slain in a hail of rapid-fire shots. The last remaining orc rode hard for a ridge line, desperately trying to escape. Boombeard had him in his sights, laughing as he aimed his hefty rifle and saying to himself... always leave one to tell the tale. Ironbeard was so happy to see his second cousin! The expedition members shared a keg in the bars of Ironforge, spreading their drunken tales of this legendary hunter. The surviving orc spoke about his ordeal, telling stories of how he survived. Word spread throughout Orgrimmar, mentioned in whispers throughout the hovels and valleys. The Horde now knew his name, and to fear it. BOOMBEARD"
    },
    {
