...
angular.module("epgpApp").service("raidService", function () {
  const raids = {
    ...
    zulgurub: {
      ...
      phase: "Phase 4",
      bosses: {
        jeklik: { name: "High Priestess Jeklik", killed: false, killDate: "2020-04-16", img: "jeklik.jpg" },
        venoxis: { name: "High Priest Venoxis", killed: false, killDate: "2020-04-16", img: "venoxis.jpg" },
        marli: { name: "High Priestess Mar'li", killed: false, killDate: "2020-04-16", img: "marli.jpg" },
        thekal: { name: "High Priest Thekal", killed: false, killDate: "2020-04-16", img: "thekal.jpg" },
        arlokk: { name: "High Priestess Arlokk", killed: false, killDate: "2020-04-16", img: "arlokk.jpg" },
        mandokir: { name: "Bloodlord Mandokir", killed: false, killDate: "2020-04-16", img: "mandokir.jpg" },
        hakkar: { name: "Hakkar the Soulflayer", killed: false, killDate: "2020-04-16", img: "hakkar.jpg" },
        wushoolay: { name: "Wushoolay", killed: false, killDate: "2020-04-16", img: "wushoolay.jpg" },
        renataki: { name: "Renataki", killed: false, killDate: "2020-04-16", img: "renataki.jpg" },
        hazzarah: { name: "Hazza'rah", killed: false, killDate: "2020-04-16", img: "hazzarah.jpg" },
        grilek: { name: "Gri'lek", killed: false, killDate: "2020-04-16", img: "grilek.jpg" },
        jindo: { name: "Jin'do the Hexxer", killed: false, killDate: "2020-04-16", img: "jindo.jpg" },
        gahzranka: { name: "Gahz'ranka", killed: false, killDate: "2020-04-16", img: "gahzranka.jpg" },
      },
    },
  };
